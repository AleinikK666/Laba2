    ...
    , ui(new Ui::Widget)
{
    ...
    f.setColor(QPalette::Window, QColor(255, 165, 0));
...
void Widget::on_multiChoice_clicked()
{
    ...
    twInfo->setHorizontalHeaderItem(5, new QTableWidgetItem("Resolution"));
    ...
    for(int i = 0; i < list.size(); i++)
    {
        ...
        twInfo->setItem(i, 5, new QTableWidgetItem(QString::number(im.physicalDpiX())));
    }
